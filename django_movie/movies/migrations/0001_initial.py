# Generated by Django 4.0.4 on 2022-04-14 22:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.fields.CharField, to='movies.movies', verbose_name='Фильмы')),
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.ratingstars', verbose_name='Звезды')),
            ],
            options={
